...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/ModelSaving_Test_6/master/APPCode/prepared_data.csv')
...
title = 'App'
encoder_location = ''
target_encoder_location = 'https://github.com/karthikreddykuna/ModelSaving_Test_6/blob/master/APPCode/target_encoder.pkl?raw=true'
